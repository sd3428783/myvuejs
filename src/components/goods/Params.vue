<template>
  <div>
    ...
    <el-card>
      <!-- 警告区域 -->
      <el-alert title="注意只允许为第三季分类设置参数" type="warning" show-icon :closable="false"></el-alert>
      <!-- 选择商品分类区域 -->
      <el-row>
        <el-col class="cat_opt">
          <span style="float: left; height: 44px; width: 120px; line-height: 44px;">选择商品分类：</span>
          <!-- 选择商品分类的级联选择框 -->
          <el-cascader
            ...
            :props="cateProps"
            @change="handleChange"
            style="width:600px; height: 44px; float: left"
          ></el-cascader>
        </el-col>
      </el-row>
      <!-- tab页签区域 -->
